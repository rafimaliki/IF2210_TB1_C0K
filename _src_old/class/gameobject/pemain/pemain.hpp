...
public:
    ...
    int getId() const
    {
       ...
       void cetakItem()
    {
        item_map.displayItems();
    }
    // method nambah item
    void addHewan(string nama)
    {
        Item *hewan = new Hewan(nama);
        item_map.addItem(hewan);
    }
    void addTumbuhan(string nama)
    {
        Item *tumbuhan = new Tumbuhan(nama);
        item_map.addItem(tumbuhan);
    }
    void addProduk(string nama)
    {
        Item *produk = new Produk(nama);
        item_map.addItem(produk);
    }
    void addBangunan(string nama)
    {
        Item *bangunan = new Bangunan();
        item_map.addItem(bangunan);
    }
